...
export function PasswordGeneratorModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="glass-card max-w-md w-full animate-bounce-in">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                readOnly
                className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-foreground font-mono text-sm"
              />
              <button
                onClick={handleCopy}
                className="px-4 py-3 bg-secondary/20 hover:bg-secondary/30 border border-secondary/30 rounded-lg transition-colors"
              >
          ...
          <div className="flex gap-3 pt-4 border-t border-white/10">
            <button
              ...
              className="flex-1 px-4 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-foreground font-medium transition-colors"
            >
              Regenerate
            </button>
            <button
              onClick={handleUse}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-medium rounded-lg transition-all duration-200"
            >
              Use This Password
            </button>
          </div>
